    ...
    if (status === 'authenticated' && userId) {
      const login = async (email) => {
        try {
          ...
          const response = await axios.post("https://next-auth-backend-5bn44i2ud-zain-appiness-projects.vercel.app/api/user/login", { email });
      ...
      const fetchProfileData = async () => {
        ...
        try {
          ...
          const response = await axios.get(`https://next-auth-backend-5bn44i2ud-zain-appiness-projects.vercel.app/api/project/user/${userId}`, {
