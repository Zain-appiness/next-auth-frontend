...
export default function Admin() {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post("https://next-auth-backend-ln9ncq7j9-zain-appiness-projects.vercel.app/api/user/login", {
        email,
      });
  ...
  const fetchProjects = async () => {
    try {
      ...
      const response = await axios.get("https://next-auth-backend-ln9ncq7j9-zain-appiness-projects.vercel.app/api/project", {
  ...
  const fetchUsers = async () => {
    try {
      const token = getToken();
      const response = await axios.get("https://next-auth-backend-ln9ncq7j9-zain-appiness-projects.vercel.app/api/user/", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingProjectId) {
        await axios.put(
          `https://next-auth-backend-ln9ncq7j9-zain-appiness-projects.vercel.app/api/project/${editingProjectId}`,
          payload,
          { headers: { Authorization: `Bearer ${token}` } }
        );
        ...
        await axios.post("https://next-auth-backend-ln9ncq7j9-zain-appiness-projects.vercel.app/api/project", payload, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleDelete = async (id) => {
    try {
      const token = getToken();
      await axios.delete(`https://next-auth-backend-ln9ncq7j9-zain-appiness-projects.vercel.app/api/project/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
